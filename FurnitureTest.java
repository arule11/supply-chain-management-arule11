...
public class FurnitureTest {
    ...
    public void testConstructor3(){
        ...
        String resultedRequest = FurnitureDataBase.furnitureRequest;
    
        String resultedType = FurnitureDataBase.requestType;
        String expectedType = "mesh";

        int resultedNum = FurnitureDataBase.requestNum;
        int expectedNum = 2;
    ...
    public void testConstructor3AddFurniture(){
        ...
        for (int i = 0; i < dataBase.foundFurniture.size(); i++){
            if  (dataBase.foundFurniture.get(i).getType().equalsIgnoreCase("Mesh")){
                resultType = true;
            }else{
                resultType = false;
            }
    ...
    public void testConstructor3ProduceOrder0(){
        ...
        dataBase.foundFurniture = createdFoundFurniture;
